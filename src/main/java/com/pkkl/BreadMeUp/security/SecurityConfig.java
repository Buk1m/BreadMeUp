...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/managerRegistration").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/admin/users/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/orders/*").hasAnyRole("USER", "MANAGER")
                .antMatchers(HttpMethod.GET, "/orders/my").hasRole("USER")
                .antMatchers(HttpMethod.POST, "/orders").hasRole("USER")
                .antMatchers(HttpMethod.PATCH, "/orders/cancel/*").hasAnyRole("USER", "MANAGER")
                .antMatchers(HttpMethod.PATCH, "/orders/finish/*").hasAnyRole("USER", "MANAGER")
